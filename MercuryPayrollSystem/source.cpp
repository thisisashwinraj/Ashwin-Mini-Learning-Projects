...
void intro()
{
    ...
    gotoXY(21,8); printf("Designed and Programmed by Ashwin Raj");
    gotoXY(19,9);for(int i=0;i<40;i++) printf("%c",196);
	gotoXY(9,11); printf("The Payroll management System enables your business to handle");
	gotoXY(5,12); printf("your employee's financial records in a hassle-free, automated fashion");
