...
Apheleia is a chrome extension that uses natural language processing to generate a summary of a web page by highlighting the important text. Summarizing is based on ranks of text sentences using a variation of algorithms.
